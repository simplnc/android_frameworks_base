...
/**
 * Helper functions for uploading to hastebin.com
 */
public final class HastebinUtils {
    ...
    /**
     * Uploads {@code content} to hastebin.com
     * 
     * @param content the content to upload to hastebin.com
        ...
        getHandler().post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    callback.onFail("Failed to upload to hastebin.com", e);
                }
            }
        });
    }
