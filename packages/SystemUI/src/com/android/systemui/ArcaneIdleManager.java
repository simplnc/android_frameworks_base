    ...
    public static void servicesKiller() {
        ...
        for (int i=0; i < RunningServices.size(); i++) {
          if (!RunningServices.get(i).pkgList[0].toString().contains("com.android.") &&
                ...
                !RunningServices.get(i).pkgList[0].toString().contains("com.whatsapp.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.spotify.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("org.telegram") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.amazon.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.twitter.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.netflix.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.discord.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.reddit.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("org.thoughtcrime.securesms") &&
                !RunningServices.get(i).pkgList[0].toString().contains("chat.delta") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.wire") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.monzo.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.barclays.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.natwest.") &&
                !RunningServices.get(i).pkgList[0].toString().contains("com.paypal.") &&
